            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-body">
                      <form method="POST" action="{{ url('admin/product/update/'.$product->id  ) }}" enctype="multipart/form-data" id="my-form">
                      @csrf
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="name">Store ID</label>
                          <div class="form-floating col-sm-10">
                          <select class="form-select"  name="storeId">
                              <option value="">Select a Store </option> 
                              @foreach ($store as $item)
                                <option value="{{$item->id}}" @if($item->id == $product->storeId ) selected @endif>{{$item->name}}</option>
                              @endforeach
                            </select>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="price" class="form-control" id="price" placeholder="John Doe" value="{{$product->price}}"/>
                            @error('price')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                          </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="discountPrice" class="form-control" id="discountPrice" placeholder="John Doe" value="{{$product->discountPrice}}"/>
                          </div>
                        </div>
                        <div class="row mb-3">
